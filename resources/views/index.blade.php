...
@section('main-content')
    ...
    <section class="categories mb-5">
        <div class="container-fluid pb-4">
            ...
            <div class="categories-btn" data-aos="fade-up">
                <ul>
                    @foreach ($categories as $category)
                        @if ($category->id == 1)
                            <li><button id="btn-{{ $category->name }}" class="btn-category active"
                                    onclick="activateBtn(this)">{{ $category->name }}</button></li>
                        @else
                            <li><button id="btn-{{ $category->name }}" class="btn-category"
                                    onclick="activateBtn(this)">{{ $category->name }}</button></li>
                        @endif
                    @endforeach
                </ul>
            ...
            <div class="content-wrapper" data-aos="" data-aos-anchor-placement="center-bottom">
                ...
                <div id="content-fiksi"
                    ...
                    @foreach ($books_fiksi as $book)
                        ...
                        @else
                            <a href="/login" class="card-wrapper col-md-4 mt-4 text-decoration-none">
                                <div class="card">
                                    <div class="card-img-block">
                                        @if ($book->cover)
                                            <img class="card-img-top" src="/storage/{{ $book->cover }}" alt="Card image cap">
                ...
                {{-- non fiksi --}}
                <div id="content-nonfiksi"
                    class="content row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center d-none">
                    @foreach ($books_nonfiksi as $book)
                        @auth
                            <a href="/books/{{ $book->id }}" class="card-wrapper col-md-4 mt-4 text-decoration-none">
                                <div class="card">
                                    <div class="card-img-block">
                        ...
                        @auth
                            <a href="/books/{{ $book->id }}" class="card-wrapper col-md-4 mt-4 text-decoration-none">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <h5 class="card-title">{{ $book->title }} (RPL)</h5>
                                        <p class="card-text">{{ $book->description }}</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        @auth
                            <a href="/books/{{ $book->id }}" class="card-wrapper col-md-4 mt-4 text-decoration-none">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <h5 class="card-title">{{ $book->title }} (OTKP)</h5>
                                        <p class="card-text">{{ $book->description }}</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        @auth
                            <a href="/books/{{ $book->id }}" class="card-wrapper col-md-4 mt-4 text-decoration-none">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <h5 class="card-title">{{ $book->title }} (PH)</h5>
                                        <p class="card-text">{{ $book->description }}</p>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="content container mt-3">
            <div class="col-12 d-flex justify-content-center" data-aos="fade-up"
                ...
                <div class="wrapper rounded p-5">
                    <svg class="stamp-icon" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                        fill="#ffc720" viewBox="0 0 256 256">
                        <path
                    ...
                    <ol>
                        ...
                        <li>
                            <p>Datang ke Perpustakaan SMKN 1 Cisarua lalu berikan kode peminjaman kepada pustakawan</p>
                        </li>
                        <li>
...
@section('script')
    <script>
        ...
        const contentRPL = document.getElementById('content-rpl');
        const contentOTKP = document.getElementById('content-otkp');
        const contentPH = document.getElementById('content-ph');
            ...
            for (let i = 0; i < categoriesBtn.length; i++) {
                ...
                if (categoriesBtn[i].classList.contains('active')) {
                    ...
                    if (category == 'btn-fiksi') {
                        ...
                        contentRPL.classList.add('d-none');
                        contentOTKP.classList.add('d-none');
                        contentPH.classList.add('d-none');

                    } else if (category == 'btn-non-fiksi') {
                        contentFiksi.classList.add('d-none');
                        contentNonfiksi.classList.remove('d-none');
                        contentRPL.classList.add('d-none');
                        contentOKP.classList.add('d-none');
                        contentPH.classList.add('d-none');

                    } else if (category == 'btn-rpl') {
                        contentFiksi.classList.add('d-none');
                        contentNonfiksi.classList.add('d-none');
                        contentRPL.classList.remove('d-none');
                        contentOKP.classList.add('d-none');
                        contentPH.classList.add('d-none');

                    } else if (category == 'btn-otkp') {
                        contentFiksi.classList.add('d-none');
                        contentNonfiksi.classList.add('d-none');
                        contentRPL.classList.add('d-none');
                        contentOTKP.classList.remove('d-none');
                        contentPH.classList.add('d-none');

                    } else if (category == 'btn-ph') {
                        contentFiksi.classList.add('d-none');
                        contentNonfiksi.classList.add('d-none');
                        contentRPL.classList.add('d-none');
                        contentOTKP.classList.add('d-none');
                        contentPH.classList.remove('d-none');
                    }

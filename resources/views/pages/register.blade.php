        ...
        <div class="col-lg-8">
          ...
          <form action='/register' method='post'>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingInput" placeholder="example" name="name" value="{{ old('name') }}">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating">
                  <input type="text" class="form-control @error('username') is-invalid @enderror" id="floatingInput" placeholder="example" name="username" value="{{ old('username') }}">
            ...
            <div class="form-floating mb-3">
              <input type="number" class="form-control @error('nis_nip') is-invalid @enderror" id="floatingInput" placeholder="example" name="nis_nip" value="{{ old('nis_nip') }}">
            ...
            <!-- Email input -->
            <div class="form-floating mb-3">
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="floatingInput" placeholder="example" name="email" value="{{ old('email') }}">
